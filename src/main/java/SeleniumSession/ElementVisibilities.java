...
public class ElementVisibilities {
	...
	public static void main(String[] args) {
		...
		System.out.println("Line 19:"+driver.findElement(By.name("agreeTerms")).isSelected());
		driver.findElement(By.name("agreeTerms")).click();//select checkbox
		System.out.println("Line 21:"+driver.findElement(By.name("agreeTerms")).isSelected());
